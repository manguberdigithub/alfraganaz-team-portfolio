    ...
    >
      <div className="w-full h-125 flex flex-col justify-between z-40">
        ...
        <div className="w-full h-64 z-30  flex flex-col justify-between 3xl:pl-24 3xl:w-4/5 2xl:w-5/6 2xl:pl-16 xl:w-full lg:h-48 sm:w-full md:h-60 xs:h-52">
          {/* Hero title */}
          <h1 className="w-full h-24 z-10  text-white font-montserrat font-extrabold text-64 leading-tight xl:h-20 xl:w-5/6 xl:text-6xl lg:w-full lg:text-5xl  md:text-5xl sm:text-5xl xs:text-4xl">
        ...
        <div className="w-full h-28 flex justify-between items-center z-40 xl:h-20 lg:h-16  md:h-14 sm:h-10 xs:h-10">
          {heroGroup.map((group) => (
            <div
              key={group.id}
              className="w-full h-5/6 flex flex-col justify-center lg:h-full xs:w-20"
            >
              <h2 className="w-36 h-24 font-montserrat text-7xl font-bold text-white xl:text-6xl lg:w-28 lg:text-5xl md:text-5xl md:w-20 sm:text-4xl xs:text-4xl xs:w-16  lg:h-full">
                {group.title}
              </h2>
